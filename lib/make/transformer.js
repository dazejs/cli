...
module.exports = function (program) {
  ...
  const env = nunjucks.configure(path.join(__dirname, '../../template/transformer'))
  ...
  try {
    ...
    console.log(chalk.green(`create ${pathObj.name} transformer success!`))
  } catch (err) {
    console.log(err)
    console.log(chalk.red('create transformer error'))
  }
}